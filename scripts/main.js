;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA YA :)','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'HEYYY', 'COBA LIHAT DEH', 'KATA INI', 'SEPERTINYA ADA YANG ANEH', 'AYO PENCET LAGI', 'AKU GA BOHONG KOK', 'PENCET LAGI', 'AKU TAHU KAMU PASTI KESAL', 'TAPI INI BENER ADA YANG ANEH SERIUS', 'AKU JANJI', 'INI TERAKHIR KALI', 'PENCET LAGI', 'AYO SEMANGAT', 'KAMU PASTI BISA', 'IHHH KAMU KURANG PENCET ITU', 'AYO DONG', 'IYA INI BENER TERAKHIR KOK', 'YASUDAH DEH', 'I', 'LOVE', 'YOU ♡', 'CEMANGAT BELAJARNYA CANTIK ♡', 'HALUS CEMANGAT YAAA', 'COALNYAA KAMUU TERLALU CANTIKK', 'SAYANGG DONG', 'KALOK NDAA CEMANGAT BELAJARR', 'NANTIKK COWOO CAMUU CEDII :(', 'JADI HALUS APA?', 'PINTERRR :) HARUS CEMANGATT', 'YANG PENTING', 'CAMU CUDA BERUSAHA DULU', 'MASALAH NILAII ITUU', 'BIAR TUHAN YANG TENTUINN', 'PROUD OFF UU MOREEE', 'WOOPYUU ♡']
